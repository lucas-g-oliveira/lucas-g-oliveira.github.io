  ...
  return (
    <div className="profile">
      ...
      <div>
        ...
        <section>
          <a href={dataProfile.linkedin} alt={dataProfile.linkedin} target="_blank">
            <img className="icon" src={linkedinIcon} />
          </a>
          <a href={`mailto:${dataProfile.email}`} alt={dataProfile.email} target="_blank">
            <img className="icon" src={emailIcon} />
          </a>
          <a href={dataProfile.gitHub} alt={dataProfile.gitHub} target="_blank">
